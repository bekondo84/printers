...
@Service
public class ImprimanteRowService implements ExcelRowService {
    @Override
    public void createRows(String[] headers, Sheet sheet, CellStyle headerStyle, List datas) {
        ...
        for (Object data: datas) {
            ...
            cell.setCellValue(printData.getPrinter().getIpAdress());
            //Nom
            cell = row.createCell(1);
            cell.setCellStyle(headerStyle);
            cell.setCellValue(printData.getPrinter().getName());
            //Service name
